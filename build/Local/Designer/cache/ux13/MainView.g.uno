...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        temp2.Nodes.Add(temp5);
        temp3.Duration = 0;
        temp3.RelativeTo = Fuse.TranslationModes.Size;
        temp3.Easing = Fuse.Animations.Easing.QuadraticOut;
        temp3.Keyframes.Add(temp4);
        temp4.Y = 0f;
        temp4.Time = 0.2;
        temp5.Factor = 0.8f;
        temp7.Value = "Back";
        temp7.Color = float4(0.1764706f, 0.2196078f, 0.3098039f, 1f);
        temp7.Margin = float4(20f, 20f, 20f, 20f);
        this.Children.Add(temp);
    }
    static global::Uno.UX.Selector __selector0 = "swipe";
}
